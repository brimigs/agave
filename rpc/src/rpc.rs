    ...
    impl Minimal for MinimalImpl {
        ...
        fn get_highest_snapshot_slot(&self, meta: Self::Metadata) -> Result<RpcSnapshotSlotInfo> {
            ...
            let (full_snapshot_archives_dir, incremental_snapshot_archives_dir) = meta
                ...
                .unwrap(); // Ensure the Option is not None
...
pub mod rpc_accounts {
    ...
    impl AccountsData for AccountsDataImpl {
        ...
        fn get_multiple_accounts(
            ...
            async move {
                let max_multiple_accounts = meta.base.config.max_multiple_accounts.unwrap_or(MAX_MULTIPLE_ACCOUNTS);
...
//     struct RpcHandler {
//     io: MetaIoHandler<RpcProcessorMetadata>,
//     meta: RpcProcessorMetadata,
//         identity: Pubkey,
...
//             let bank = self.working_bank();
//             let prioritization_fee_cache = &self.meta.processor.prioritization_fee_cache;
...
//             &self.meta.processor.prioritization_fee_cache
//         }
